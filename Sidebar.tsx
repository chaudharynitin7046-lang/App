    ...
    <aside className="w-64 bg-slate-900 text-white flex flex-col hidden md:flex">
      <div className="p-6 flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          <span className="text-sm font-bold tracking-tight text-white leading-tight">Momai</span>
          <span className="text-xs font-medium text-orange-400 uppercase tracking-widest">Cattelfood</span>
        </div>
      </div>
